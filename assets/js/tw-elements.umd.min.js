(function (L, P) {
  typeof exports == "object" && typeof module < "u"
    ...
    ? define(["exports"], P)
    : ((L = typeof globalThis < "u" ? globalThis : L || self), P((L.twe = {})));
})(this, function (L) {
  "use strict";
  var jl = Object.defineProperty;
  var Ul = (L, P, R) =>
    P in L
      ? jl(L, P, { enumerable: !0, configurable: !0, writable: !0, value: R })
      : (L[P] = R);
  var $i = (L, P, R) => (Ul(L, typeof P != "symbol" ? P + "" : P, R), R);
  /*!
   * TW Elements
   * Version: FREE 2.0.0
   *
   ...
   */ const P = (() => {
    ...
    Un = (i) =>
      i == null
        ...
        : {}.toString
            ...
            .toLowerCase(),
    Yn = (i) => {
      do i += Math.floor(Math.random() * Bn);
    ...
    Mi = (i, t, e = !0) => {
      ...
      let r = !1;
      const o = ({ target: a }) => {
        a === t && ((r = !0), t.removeEventListener(Ie, o), dt(i));
      };
      t.addEventListener(Ie, o),
        setTimeout(() => {
          r || Ri(t);
        }, n);
    },
    ...
    Pe = {};
  let Vi = 1;
  const qn = { mouseenter: "mouseover", mouseleave: "mouseout" },
    Xn = /^(mouseenter|mouseleave)/i,
    Wi = new Set([
      "click",
      "dblclick",
      "mouseup",
  ...
  function Bi(i, t) {
    return (t && `${t}::${Vi++}`) || i.uidEvent || Vi++;
  }
  function ji(i) {
    const t = Bi(i);
    return (i.uidEvent = t), (Pe[t] = Pe[t] || {}), Pe[t];
  }
  function Gn(i, t) {
    return function e(s) {
      return (
        (s.delegateTarget = i), e.oneOff && d.off(i, s.type, t), t.apply(i, [s])
      );
    };
  }
  function Qn(i, t, e) {
      ...
      for (let { target: o } = n; o && o !== this; o = o.parentNode)
        for (let a = r.length; a--; "")
          if (r[a] === o)
            return (
              (n.delegateTarget = o),
              s.oneOff && d.off(i, n.type, e),
              e.apply(o, [n])
            );
      return null;
    };
  }
  function Ui(i, t, e = null) {
  ...
  function Yi(i, t, e) {
    const s = typeof t == "string",
      n = s ? e : t;
    let r = Fi(i);
    return Wi.has(r) || (r = i), [s, n, r];
  }
  function Ki(i, t, e, s, n) {
    if (typeof t != "string" || !i) return;
    if ((e || ((e = s), (s = null)), Xn.test(t))) {
      const g = (O) =>
        function (T) {
          if (
            !T.relatedTarget ||
    ...
    const f = Bi(o, t.replace(Kn, "")),
      v = r ? Qn(i, e, s) : Gn(i, e);
    (v.delegationSelector = r ? e : null),
      (v.originalHandler = o),
      (v.oneOff = n),
      (v.uidEvent = f),
      (u[f] = v),
      i.addEventListener(a, v, r);
  }
  ...
  function Zn(i, t, e, s) {
    ...
    Object.keys(n).forEach((r) => {
      if (r.includes(s)) {
        const o = n[r];
        Me(i, t, e, o.originalHandler, o.delegationSelector);
      }
    });
  }
  function Fi(i) {
    return (i = i.replace(Fn, "")), qn[i] || i;
  }
  const d = {
      on(i, t, e, s) {
        Ki(i, t, e, s, !1);
      ...
      off(i, t, e, s) {
        ...
        Object.keys(c).forEach((f) => {
          const v = f.replace(zn, "");
          if (!a || t.includes(v)) {
            const g = c[f];
            Me(i, l, o, g.originalHandler, g.delegationSelector);
          }
        });
      },
      trigger(i, t, e) {
        ...
        return (
          ...
          o
            ? ((f = document.createEvent("HTMLEvents")), f.initEvent(n, l, !0))
  ...
  class et {
    ...
    static getInstance(t) {
      return R.getData(nt(t), this.DATA_KEY);
    }
  ...
  class ne extends et {
    ...
    toggle() {
      this._element.setAttribute(
        "aria-pressed",
        this._element.classList.toggle(er)
      );
    }
    static jQueryInterface(t) {
      return this.each(function () {
        const e = ne.getOrCreateInstance(this);
        t === "toggle" && e[t]();
      });
    }
  }
  var M = "top",
    ...
    Nt = "popper",
    qi = "reference",
    Ve = Ot.reduce(function (i, t) {
      return i.concat([t + "-" + ut, t + "-" + Dt]);
    }, []),
    We = [].concat(Ot, [re]).reduce(function (i, t) {
      return i.concat([t, t + "-" + ut, t + "-" + Dt]);
    }, []),
    Xi = "beforeRead",
    Gi = "read",
    Qi = "afterRead",
  ...
  function Lt(i, t, e) {
    ...
    t &&
      F(i) &&
      ((n = (i.offsetWidth > 0 && St(s.width) / i.offsetWidth) || 1),
      (r = (i.offsetHeight > 0 && St(s.height) / i.offsetHeight) || 1));
    var o = ht(i) ? U(i) : window,
      a = o.visualViewport,
      l = !rs() && e,
      u = (s.left + (l && a ? a.offsetLeft : 0)) / n,
  ...
  function rt(i) {
    return (
      (ht(i) ? i.ownerDocument : i.document) || window.document
    ).documentElement;
  }
  function ae(i) {
    return Q(i) === "html"
      ? i
      : i.assignedSlot || i.parentNode || (Be(i) ? i.host : null) || rt(i);
  }
  function as(i) {
    return !F(i) || it(i).position === "fixed" ? null : i.offsetParent;
  }
  function rr(i) {
    ...
    var n = ae(i);
    for (Be(n) && (n = n.host); F(n) && ["html", "body"].indexOf(Q(n)) < 0; ) {
      var r = it(n);
      if (
        r.transform !== "none" ||
        r.perspective !== "none" ||
  ...
  function Kt(i) {
    for (var t = U(i), e = as(i); e && nr(e) && it(e).position === "static"; )
      e = as(e);
    return e &&
      (Q(e) === "html" || (Q(e) === "body" && it(e).position === "static"))
      ? t
      : e || rr(i) || t;
  }
  function Ke(i) {
  ...
  function cr(i) {
    ...
    n != null &&
      ((typeof n == "string" &&
        ...
        (os(t.elements.popper, n) && (t.elements.arrow = n)));
  }
  const us = {
    name: "arrow",
    enabled: !0,
  ...
  var dr = { top: "auto", right: "auto", bottom: "auto", left: "auto" };
  function ur(i, t) {
    var e = i.x,
      s = i.y,
      n = t.devicePixelRatio || 1;
    return { x: St(e * n) / n || 0, y: St(s * n) / n || 0 };
  }
  function hs(i) {
    var t,
      e = i.popper,
      ...
      O = o.y,
      T = O === void 0 ? 0 : O,
      y = typeof c == "function" ? c({ x: g, y: T }) : { x: g, y: T };
    (g = y.x), (T = y.y);
    ...
    if (u) {
      ...
      if (
        ...
        p = B;
        var A =
          f && b === _ && _.visualViewport ? _.visualViewport.height : b[w];
        (T -= A - s.height), (T *= l ? 1 : -1);
      }
      if (n === H || ((n === M || n === B) && r === Dt)) {
        m = j;
        var N =
          f && b === _ && _.visualViewport ? _.visualViewport.width : b[C];
        (g -= N - s.width), (g *= l ? 1 : -1);
      }
    }
    var $ = Object.assign({ position: a }, u && dr),
      V = c === !0 ? ur({ x: g, y: T }, U(e)) : { x: g, y: T };
    if (((g = V.x), (T = V.y), l)) {
      var k;
    ...
    return (
      r &&
        u.forEach(function (c) {
          c.addEventListener("scroll", e.update, le);
        }),
      a && l.addEventListener("resize", e.update, le),
      function () {
        r &&
          u.forEach(function (c) {
            c.removeEventListener("scroll", e.update, le);
          }),
          a && l.removeEventListener("resize", e.update, le);
      }
    );
  }
  const ze = {
  ...
  function Xe(i) {
    return Lt(rt(i)).left + qe(i).scrollLeft;
  }
  function gr(i, t) {
    var e = U(i),
      s = rt(i),
    ...
    return { width: r, height: o, x: a + Xe(i), y: l };
  }
  function mr(i) {
    var t,
      e = rt(i),
      ...
      l = -s.scrollTop;
    return (
      it(n || e).direction === "rtl" &&
        (a += ft(e.clientWidth, n ? n.clientWidth : 0) - r),
  ...
  function ps(i) {
    return ["html", "body", "#document"].indexOf(Q(i)) >= 0
  ...
  function zt(i, t) {
    ...
    var s = ps(i),
      ...
      r = U(s),
      o = n ? [r].concat(r.visualViewport || [], Ge(s) ? s : []) : s,
      a = t.concat(o);
    return n ? a : a.concat(zt(ae(o)));
  }
  function Qe(i) {
  ...
  function _s(i, t, e) {
    return t === He ? Qe(gr(i, e)) : ht(t) ? Er(t, e) : Qe(mr(rt(i)));
  }
  function vr(i) {
    var t = zt(ae(i)),
      e = ["absolute", "fixed"].indexOf(it(i).position) >= 0,
      s = e && F(i) ? Kt(i) : i;
    return ht(s)
      ? t.filter(function (n) {
          return ht(n) && os(n, s) && Q(n) !== "body";
        })
      : [];
  }
  function br(i, t, e, s) {
    var n = t === "clippingParents" ? vr(i) : [].concat(t),
      r = [].concat(n, [e]),
      o = r[0],
      a = r.reduce(function (l, u) {
        var c = _s(i, u, s);
        return (
          (l.top = ft(c.top, l.top)),
          (l.right = oe(c.right, l.right)),
          (l.bottom = oe(c.bottom, l.bottom)),
          (l.left = ft(c.left, l.left)),
          l
        );
      }, _s(i, o, s));
    return (
  ...
  function It(i, t) {
    ...
    var e = t,
      ...
      T = e.padding,
      y = T === void 0 ? 0 : T,
      D = cs(typeof y != "number" ? y : ds(y, Ot)),
      I = v === Nt ? qi : Nt,
      m = i.rects.popper,
      p = i.elements[O ? I : v],
      _ = br(ht(p) ? p : p.contextElement || rt(i.elements.popper), l, c, o),
      b = Lt(i.elements.reference),
      w = gs({ reference: b, element: m, strategy: "absolute", placement: n }),
      C = Qe(Object.assign({}, m, w)),
      A = v === Nt ? C : b,
      N = {
        top: _.top - A.top + D.top,
        bottom: A.bottom - _.bottom + D.bottom,
        left: _.left - A.left + D.left,
        right: A.right - _.right + D.right,
      },
      $ = i.modifiersData.offset;
    if (v === Nt && $) {
      var V = $[n];
      Object.keys(N).forEach(function (k) {
        var vt = [j, B].indexOf(k) >= 0 ? 1 : -1,
          bt = [M, B].indexOf(k) >= 0 ? "y" : "x";
        N[k] += V[bt] * vt;
      });
    }
    return N;
  ...
  function wr(i, t) {
    ...
    var e = t,
      ...
      f = c
        ? a
          ? Ve
          : Ve.filter(function (O) {
              return $t(O) === c;
            })
        : Ot,
      v = f.filter(function (O) {
    ...
    if (!t.modifiersData[s]._skip) {
      for (
        var n = e.mainAxis,
          ...
          g = e.flipVariations,
          O = g === void 0 ? !0 : g,
          T = e.allowedAutoPlacements,
          y = t.options.placement,
          D = Z(y),
          I = D === y,
          m = l || (I || !O ? [ce(y)] : Tr(y)),
          p = [y].concat(m).reduce(function (jt, lt) {
            return jt.concat(
              Z(lt) === re
                ? wr(t, {
                    placement: lt,
        ...
        if (
          (r && wt.push(K[V] <= 0),
          a && wt.push(K[G] <= 0, K[De] <= 0),
          wt.every(function (jt) {
            return jt;
          }))
        ) {
          (A = $), (C = !1);
      ...
      if (C)
        for (
          var Ne = O ? 3 : 1,
            Di = function (lt) {
              var ie = p.find(function (Le) {
                var Tt = w.get(Le);
                if (Tt)
                  return Tt.slice(0, lt).every(function (Ni) {
                    return Ni;
                  });
              });
      ...
      t.placement !== A &&
        ((t.modifiersData[s]._skip = !0), (t.placement = A), (t.reset = !0));
    }
  }
  const ms = {
    name: "flip",
  ...
  function vs(i) {
    return [M, j, B, H].some(function (t) {
      return i[t] >= 0;
    });
  }
  function yr(i) {
  ...
  function Cr(i, t, e) {
    ...
    return (
      (o = o || 0),
      (a = (a || 0) * n),
      [H, j].indexOf(s) >= 0 ? { x: a, y: o } : { x: o, y: a }
    );
  }
  function Or(i) {
    var t = i.state,
      ...
      n = e.offset,
      r = n === void 0 ? [0, 0] : n,
      o = We.reduce(function (c, f) {
        return (c[f] = Cr(f, t.rects, r)), c;
      }, {}),
      a = o[t.placement],
      l = a.x,
      u = a.y;
  ...
  function Sr(i) {
    var t = i.state,
      ...
      O = e.tetherOffset,
      T = O === void 0 ? 0 : O,
      y = It(t, { boundary: l, rootBoundary: u, padding: f, altBoundary: c }),
      D = Z(t.placement),
      I = $t(t.placement),
      m = !I,
      p = Ke(D),
    ...
    if (b) {
      if (r) {
        var k,
          ...
          ee = I === ut ? -C[K] : -w[K],
          Se = t.elements.arrow,
          jt = g && Se ? Ye(Se) : { width: 0, height: 0 },
          lt = t.modifiersData["arrow#persistent"]
          ...
          Tt = Ft(0, w[K], jt[K]),
          Ni = m
            ? w[K] / 2 - Ne - Tt - ie - N.mainAxis
            : Di - Tt - ie - N.mainAxis,
          Pl = m
            ? -w[K] / 2 + Ne + Tt + Le + N.mainAxis
            : ee + Tt + Le + N.mainAxis,
          Si = t.elements.arrow && Kt(t.elements.arrow),
          Ml = Si ? (p === "y" ? Si.clientTop || 0 : Si.clientLeft || 0) : 0,
          In = (k = $ == null ? void 0 : $[p]) != null ? k : 0,
          Hl = G + Ni - In - Ml,
          Vl = G + Pl - In,
          Rn = Ft(g ? oe(De, Hl) : De, G, g ? ft(wt, Vl) : wt);
        (b[p] = Rn), (V[p] = Rn - G);
      }
      if (a) {
        var kn,
          ...
          Pn = At - y[Bl],
          Li = [M, H].indexOf(D) !== -1,
          Mn = (kn = $ == null ? void 0 : $[_]) != null ? kn : 0,
          Hn = Li ? xn : At - w[$e] - C[$e] - Mn + N.altAxis,
          Vn = Li ? At + w[$e] + C[$e] - Mn - N.altAxis : Pn,
          Wn = g && Li ? or(Hn, At, Vn) : Ft(g ? Hn : xn, At, g ? Vn : Pn);
        (b[_] = Wn), (V[_] = Wn - At);
      }
      t.modifiersData[s] = V;
    }
  ...
  function $r(i) {
    return i === U(i) || !F(i) ? qe(i) : Lr(i);
  }
  function Ir(i) {
    var t = i.getBoundingClientRect(),
      e = St(t.width) / i.offsetWidth || 1,
      s = St(t.height) / i.offsetHeight || 1;
    return e !== 1 || s !== 1;
  }
  function Rr(i, t, e) {
    e === void 0 && (e = !1);
    ...
    return (
      (s || (!s && !e)) &&
        ((Q(t) !== "body" || Ge(r)) && (a = $r(t)),
        F(t)
          ? ((l = Lt(t, !0)), (l.x += t.clientLeft), (l.y += t.clientTop))
          : r && (l.x = Xe(r))),
      {
      ...
      var c = {
        ...
        g = {
          ...
          setOptions: function (D) {
            ...
            T(),
              (c.options = Object.assign({}, r, c.options, I)),
              (c.scrollParents = {
                reference: ht(a)
                  ? zt(a)
                  : a.contextElement
            ...
            var m = xr(Mr([].concat(s, c.options.modifiers)));
            return (
              (c.orderedModifiers = m.filter(function (p) {
                return p.enabled;
              })),
              O(),
              g.update()
          ...
          forceUpdate: function () {
            if (!v) {
              ...
              if (ys(I, m)) {
                (c.rects = {
                  reference: Rr(I, Kt(m), c.options.strategy === "fixed"),
                  popper: Ye(m),
                }),
                  (c.reset = !1),
                  (c.placement = c.options.placement),
                  c.orderedModifiers.forEach(function (N) {
                    return (c.modifiersData[N.name] = Object.assign(
                      {},
                      N.data
                    ));
                  });
                for (var p = 0; p < c.orderedModifiers.length; p++) {
                  ...
                  typeof b == "function" &&
                    (c =
                      b({ state: c, options: C, name: A, instance: g }) || c);
                }
              }
            }
          },
      ...
      function O() {
        c.orderedModifiers.forEach(function (y) {
          ...
          if (typeof p == "function") {
            var _ = p({ state: c, name: D, instance: g, options: m }),
              b = function () {};
            f.push(_ || b);
          }
        });
  ...
  var Hr = de(),
    Vr = [ze, Ze, Fe, je],
    Wr = de({ defaultModifiers: Vr }),
    Br = [ze, Ze, Fe, je, ws, ms, Ts, us, bs],
    Je = de({ defaultModifiers: Br });
  ...
  const E = {
    setDataAttribute(i, t, e) {
      i.setAttribute(`data-twe-${ei(t)}`, e);
    },
    removeDataAttribute(i, t) {
      i.removeAttribute(`data-twe-${ei(t)}`);
    },
    getDataAttributes(i) {
      if (!i) return {};
      const t = {};
    ...
    getDataClassAttributes(i) {
      ...
      return (
        Object.keys(t)
          .filter((e) => e.startsWith("tweClass"))
          .forEach((e) => {
    ...
    getDataAttribute(i, t) {
      return ti(i.getAttribute(`data-twe-${ei(t)}`));
    },
    offset(i) {
    ...
    addClass(i, t) {
      ii(t).forEach((e) => !i.classList.contains(e) && i.classList.add(e));
    },
    addStyle(i, t) {
    ...
    removeClass(i, t) {
      ii(t).forEach((e) => i.classList.contains(e) && i.classList.remove(e));
    },
    hasClass(i, t) {
  ...
  const jr = 3,
    h = {
      ...
      parents(i, t) {
        const e = [];
        let s = i.parentNode;
        for (; s && s.nodeType === Node.ELEMENT_NODE && s.nodeType !== jr; )
      ...
      focusableChildren(i) {
        const t = [
          ...
          .join(", ");
        return this.find(t, i).filter((e) => !ct(e) && Ct(e));
      },
    },
    si = "dropdown",
    pt = ".twe.dropdown",
    ...
    Zr = "dropend",
    Jr = "dropstart",
    to = "[data-twe-navbar-ref]",
    fe = "[data-twe-dropdown-toggle-ref]",
    oi = "[data-twe-dropdown-menu-ref]",
    eo = "[data-twe-navbar-nav-ref]",
    io =
      "[data-twe-dropdown-menu-ref] [data-twe-dropdown-item-ref]:not(.disabled):not(:disabled)",
    so = W() ? "top-end" : "top-start",
    no = W() ? "top-start" : "top-end",
    ro = W() ? "bottom-end" : "bottom-start",
    oo = W() ? "bottom-start" : "bottom-end",
    ao = W() ? "left-start" : "right-start",
    lo = W() ? "right-start" : "left-start",
    co = [{ opacity: "0" }, { opacity: "1" }],
    uo = [{ opacity: "1" }, { opacity: "0" }],
    Ss = { iterations: 1, easing: "ease", fill: "both" },
    ho = {
      offset: [0, 2],
  ...
  class z extends et {
    ...
    show() {
      ...
      if (d.trigger(this._element, zr, t).defaultPrevented) return;
      const s = z.getParentFromElement(this._element);
      this._inNavbar
        ? E.setDataAttribute(this._menu, "popper", "none")
        : this._createPopper(s),
        "ontouchstart" in document.documentElement &&
          !s.closest(eo) &&
          []
            .concat(...document.body.children)
            .forEach((n) => d.on(n, "mouseover", se)),
        this._element.focus(),
        this._element.setAttribute("aria-expanded", !0),
        this._menu.setAttribute(`data-twe-dropdown-${ot}`, ""),
        this._animationCanPlay &&
          this._menu.animate(co, {
            ...Ss,
            duration: this._config.animationDuration,
          }),
        this._element.setAttribute(`data-twe-dropdown-${ot}`, ""),
        setTimeout(
          () => {
            d.trigger(this._element, qr, t);
          },
    ...
    _init() {
      this._didInit ||
        (d.on(document, Ns, fe, z.dataApiKeydownHandler),
        d.on(document, Ns, oi, z.dataApiKeydownHandler),
        d.on(document, Xr, z.clearMenus),
        d.on(document, Gr, z.clearMenus),
        (this._didInit = !0));
    }
    _completeHide(t) {
      (this._fadeOutAnimate && this._fadeOutAnimate.playState === "running") ||
        d.trigger(this._element, Kr, t).defaultPrevented ||
        ("ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((s) => d.off(s, "mouseover", se)),
        this._animationCanPlay &&
          (this._fadeOutAnimate = this._menu.animate(uo, {
            ...Ss,
            duration: this._config.animationDuration,
          })),
        setTimeout(
          () => {
            this._popper && this._popper.destroy(),
              this._menu.removeAttribute(`data-twe-dropdown-${ot}`),
              this._element.removeAttribute(`data-twe-dropdown-${ot}`),
              this._element.setAttribute("aria-expanded", "false"),
              E.removeDataAttribute(this._menu, "popper"),
              d.trigger(this._element, Fr, t);
          },
          this._animationCanPlay ? this._config.animationDuration : 0
        ));
    }
    _getConfig(t) {
      if (
        ...
        x(si, t, this.constructor.DefaultType),
        typeof t.reference == "object" &&
          !yt(t.reference) &&
          typeof t.reference.getBoundingClientRect != "function")
      )
        throw new TypeError(
          `${si.toUpperCase()}: Option "reference" provided type "object" without a required "getBoundingClientRect" method.`
        );
      return t;
    }
    _createPopper(t) {
      ...
      (this._popper = Je(e, this._menu, s)),
        n && E.setDataAttribute(this._menu, "popper", "static");
    }
    _isShown(t = this._element) {
      return (
        t.dataset[`tweDropdown${ot.charAt(0).toUpperCase() + ot.slice(1)}`] ===
        ""
      );
    }
    _getMenuElement() {
      return h.next(this._element, oi)[0];
    }
    _getPlacement() {
      const t = this._element.parentNode;
      if (t.dataset.tweDropdownPosition === Zr) return ao;
      if (t.dataset.tweDropdownPosition === Jr) return lo;
      const e = t.dataset.tweDropdownAlignment === "end";
      return t.dataset.tweDropdownPosition === Qr ? (e ? no : so) : e ? oo : ro;
    }
    _detectNavbar() {
    ...
    _selectMenuItem({ key: t, target: e }) {
      const s = h.find(io, this._menu).filter(Ct);
      s.length && Hi(s, e, t === he, !s.includes(e)).focus();
    }
    static jQueryInterface(t) {
      return this.each(function () {
    ...
    static clearMenus(t) {
      if (t && (t.button === Ur || (t.type === "keyup" && t.key !== Ds)))
        return;
      const e = h.find(fe);
      for (let s = 0, n = e.length; s < n; s++) {
        const r = z.getInstance(e[s]);
        ...
        if (t) {
          ...
          if (
            ...
            (r._config.autoClose === "inside" && !l) ||
            (r._config.autoClose === "outside" && l) ||
            (r._menu.contains(t.target) &&
              ((t.type === "keyup" && t.key === Ds) ||
    ...
    static dataApiKeydownHandler(t) {
      if (
        /input|textarea/i.test(t.target.tagName)
          ? t.key === Os ||
            (t.key !== ue &&
              ((t.key !== he && t.key !== ri) || t.target.closest(oi)))
          : !Yr.test(t.key)
      )
        return;
      const e =
        this.dataset[
          `tweDropdown${ot.charAt(0).toUpperCase() + ot.slice(1)}`
        ] === "";
      if (
        (!e && t.key === ue) ||
        ...
        return;
      const s = this.matches(fe) ? this : h.prev(this, fe)[0],
        n = z.getOrCreateInstance(s);
      if (t.key === ue) {
        n.hide();
        return;
      }
      if (t.key === ri || t.key === he) {
        e || n.show(), n._selectMenuItem(t);
        return;
      }
      (!e || t.key === Os) && z.clearMenus();
    }
  }
  const ai = "collapse",
    Ls = "twe.collapse",
    pe = `.${Ls}`,
    $s = { toggle: !0, parent: null },
    po = { toggle: "boolean", parent: "(null|element)" },
    _o = `show${pe}`,
    go = `shown${pe}`,
    mo = `hide${pe}`,
    Eo = `hidden${pe}`,
    li = "data-twe-collapse-show",
    Is = "data-twe-collapse-collapsed",
    _e = "data-twe-collapse-collapsing",
    vo = "data-twe-collapse-horizontal",
    Rt = "data-twe-collapse-item",
    Rs = `:scope [${Rt}] [${Rt}]`,
    bo = "width",
    wo = "height",
    To =
      "[data-twe-collapse-item][data-twe-collapse-show], [data-twe-collapse-item][data-twe-collapse-collapsing]",
    ks = "[data-twe-collapse-init]",
    Ao = {
      visible: "!visible",
      hidden: "hidden",
      baseTransition:
  ...
  class kt extends et {
    constructor(t, e, s) {
      ...
      for (let r = 0, o = n.length; r < o; r++) {
        const a = n[r],
          l = Re(a),
          u = h.find(l).filter((c) => c === this._element);
        l !== null &&
          u.length &&
    ...
    show() {
      ...
      if (this._config.parent) {
        const c = h.find(Rs, this._config.parent);
        t = h.find(To, this._config.parent).filter((f) => !c.includes(f));
      }
      const s = h.findOne(this._selector);
      if (t.length) {
        const c = t.find((f) => s !== f);
        if (((e = c ? kt.getInstance(c) : null), e && e._isTransitioning))
          return;
      }
      if (d.trigger(this._element, _o).defaultPrevented) return;
      t.forEach((c) => {
        s !== c && kt.getOrCreateInstance(c, { toggle: !1 }).hide(),
          e || R.setData(c, Ls, null);
      });
      ...
      E.removeClass(this._element, this._classes.visible),
        E.removeClass(this._element, this._classes.hidden),
        E.addClass(this._element, o),
        this._element.removeAttribute(Rt),
        this._element.setAttribute(_e, ""),
      ...
      const a = () => {
          (this._isTransitioning = !1),
            ...
            E.addClass(this._element, this._classes.visible),
            this._element.removeAttribute(_e),
            this._element.setAttribute(Rt, ""),
            this._element.setAttribute(li, ""),
            (this._element.style[r] = ""),
            d.trigger(this._element, go);
        },
    ...
    hide() {
      ...
      (this._element.style[e] = `${
        ...
        Ut(this._element),
        E.addClass(this._element, s),
        E.removeClass(this._element, this._classes.visible),
        E.removeClass(this._element, this._classes.hidden),
        this._element.setAttribute(_e, ""),
        this._element.removeAttribute(Rt),
        this._element.removeAttribute(li);
      ...
      const r = () => {
        (this._isTransitioning = !1),
          ...
          E.addClass(this._element, this._classes.visible),
          E.addClass(this._element, this._classes.hidden),
          this._element.removeAttribute(_e),
          this._element.setAttribute(Rt, ""),
    ...
    _isShown(t = this._element) {
      return t.hasAttribute(li);
    }
    _getConfig(t) {
      return (
        (t = { ...$s, ...E.getDataAttributes(this._element), ...t }),
        (t.toggle = !!t.toggle),
        (t.parent = nt(t.parent)),
        x(ai, t, po),
        t
      );
    }
    _getClasses(t) {
      ...
      return (t = { ...Ao, ...e, ...t }), x(ai, t, yo), t;
    }
    _getDimension() {
      return this._element.hasAttribute(vo) ? bo : wo;
    }
    _initializeChildren() {
      if (!this._config.parent) return;
      const t = h.find(Rs, this._config.parent);
      h.find(ks, this._config.parent)
    ...
    _addAriaAndCollapsedClass(t, e) {
      t.length &&
        t.forEach((s) => {
          e ? s.removeAttribute(Is) : s.setAttribute(`${Is}`, ""),
  ...
  const xs = ".fixed-top, .fixed-bottom, .is-fixed, .sticky-top",
    Ps = ".sticky-top";
  class ci {
    constructor() {
    ...
    hide() {
      ...
      this._disableOverFlow(),
        ...
        this._setElementAttributes(xs, "paddingRight", (e) => e + t),
        this._setElementAttributes(Ps, "marginRight", (e) => e - t);
    }
    _disableOverFlow() {
    ...
    reset() {
      this._resetElementAttributes(this._element, "overflow"),
        ...
        this._resetElementAttributes(xs, "paddingRight"),
        this._resetElementAttributes(Ps, "marginRight");
    }
    ...
    _resetElementAttributes(t, e) {
      const s = (n) => {
        ...
        typeof r > "u"
          ...
          : (E.removeDataAttribute(n, e), (n.style[e] = r));
      };
      this._applyManipulationCallback(t, s);
    }
    _applyManipulationCallback(t, e) {
      yt(t) ? e(t) : h.find(t, this._element).forEach(e);
    }
    isOverflowing() {
  ...
  class Vs {
    ...
    show(t) {
      ...
      this._append(), this._config.isAnimated && Ut(this._getElement());
      ...
      E.removeClass(this._getElement(), "opacity-0"),
        E.addClass(this._getElement(), e),
    ...
    _getConfig(t) {
      return (
        (t = { ...Co, ...(typeof t == "object" ? t : {}) }),
        (t.rootElement = nt(t.rootElement)),
        x(Ms, t, Oo),
        t
      );
    }
    ...
    dispose() {
      this._isAppended &&
        (d.off(this._element, Hs),
        this._element.remove(),
        (this._isAppended = !1));
    }
    _emulateAnimation(t) {
      Mi(t, this._getElement(), this._config.isAnimated);
    }
  }
  class Ws {
    constructor(t, e = {}, s) {
    ...
    _setElements() {
      ...
      (this._focusableElements = t.filter((e) => {
        const s =
          e.getAttribute("data-twe-disabled") === "true" ||
  ...
  const js = (i, t = "hide") => {
      ...
      Bs.includes(s) ||
        (Bs.push(s),
        d.on(document, e, `[data-twe-${s}-dismiss]`, function (n) {
          if (
    ...
    No = `load${xt}.data-api`,
    So = "Escape",
    Ys = { backdrop: !0, keyboard: !0, scroll: !1 },
    Lo = { backdrop: "boolean", keyboard: "boolean", scroll: "boolean" },
    Ks = "show",
    $o = "[data-twe-offcanvas-init][data-twe-offcanvas-show]",
    Io = `show${xt}`,
    Ro = `shown${xt}`,
    ko = `hide${xt}`,
    xo = `hidden${xt}`,
    Po = `keydown.dismiss${xt}`;
  class Pt extends et {
    constructor(t, e) {
      super(t),
        (this._config = this._getConfig(e)),
    ...
    show(t) {
      if (
        this._isShown ||
        d.trigger(this._element, Io, { relatedTarget: t }).defaultPrevented
      )
        return;
      (this._isShown = !0),
        ...
        this._element.setAttribute(`data-twe-offcanvas-${Ks}`, "");
      const s = () => {
        this._config.scroll || this._focustrap.trap(),
          d.trigger(this._element, Ro, { relatedTarget: t });
      };
      this._queueCallback(s, this._element, !0);
    }
    hide() {
      if (!this._isShown || d.trigger(this._element, ko).defaultPrevented)
        return;
      this._focustrap.disable(),
        this._element.blur(),
        (this._isShown = !1),
        this._element.removeAttribute(`data-twe-offcanvas-${Ks}`),
        this._backdrop.hide();
      const e = () => {
    ...
    _init() {
      this._didInit ||
        (d.on(window, No, () =>
          h.find($o).forEach((t) => Pt.getOrCreateInstance(t).show())
        ),
        (this._didInit = !0),
        js(Pt));
    }
    ...
    _initializeFocusTrap() {
      return new Ws(this._element, {
        event: "keydown",
        condition: (t) => t.keyCode === Do,
        onlyVisible: !0,
      });
    }
    _addEventListeners() {
      d.on(this._element, Po, (t) => {
        this._config.keyboard && t.key === So && this.hide();
      });
    }
    static jQueryInterface(t) {
      return this.each(function () {
  ...
  const di = "carousel",
    ...
    qs = `load${Y}${Fs}`,
    Xs = `click${Y}${Fs}`,
    Xt = "data-twe-carousel-active",
    ea = "data-twe-carousel-item-end",
    hi = "data-twe-carousel-item-start",
    ia = "data-twe-carousel-item-next",
    sa = "data-twe-carousel-item-prev",
    na = "data-twe-carousel-pointer-event",
    ra = "[data-twe-carousel-init]",
    Gs = "[data-twe-carousel-active]",
    fi = "[data-twe-carousel-item]",
    Mt = `${Gs}${fi}`,
    oa = `${fi} img`,
    aa = "[data-twe-carousel-item-next], [data-twe-carousel-item-prev]",
    la = "[data-twe-carousel-indicators]",
    ca = "[data-twe-target]",
    Qs = "[data-twe-slide], [data-twe-slide-to]",
    da = "touch",
    ua = "pen";
  class q extends et {
    constructor(t, e, s) {
      super(t),
        ...
        (this._config = this._getConfig(e)),
        (this._classes = this._getClasses(s)),
        (this._indicatorsElement = h.findOne(la, this._element)),
    ...
    pause(t) {
      t || (this._isPaused = !0),
        h.findOne(aa, this._element) && (Ri(this._element), this.cycle(!0)),
    ...
    to(t) {
      this._activeElement = h.findOne(Mt, this._element);
      const e = this._getItemIndex(this._activeElement);
      if (t > this._items.length - 1 || t < 0) return;
      if (this._isSliding) {
        d.one(this._element, ui, () => this.to(t));
        return;
      }
      if (e === t) {
    ...
    dispose() {
      d.off(document, Xs, Qs, q.dataApiClickHandler),
        d.off(window, qs),
        super.dispose();
    }
    _init() {
      this._didInit ||
        (d.on(document, Xs, Qs, q.dataApiClickHandler),
        d.on(window, qs, () => {
          const t = h.find(ra);
          for (let e = 0, s = t.length; e < s; e++)
            q.carouselInterface(t[e], q.getInstance(t[e]));
        }),
        (this._didInit = !0));
    }
    _getConfig(t) {
    ...
    _getClasses(t) {
      const e = E.getDataClassAttributes(this._element);
      return (t = { ...jo, ...e, ...t }), x(di, t, Uo), t;
    }
    _enableCycle() {
      if (this._config.ride) {
        if (this._isSliding) {
          d.one(this._element, ui, () => this.cycle());
          return;
        }
        this.cycle();
      }
    ...
    _applyInitialClasses() {
      const t = h.findOne(Mt, this._element);
    ...
    _handleSwipe() {
      ...
      (this.touchDeltaX = 0), e && this._slide(e > 0 ? qt : mt);
    }
    ...
    _addEventListeners() {
      this._config.keyboard && d.on(this._element, Fo, (t) => this._keydown(t)),
        this._config.pause === "hover" &&
          (d.on(this._element, zo, (t) => this.pause(t)),
          d.on(this._element, qo, (t) => this._enableCycle(t))),
        this._config.touch &&
          this._touchSupported &&
    ...
    _addTouchEventListeners() {
      const t = (r) =>
          this._pointerEvent && (r.pointerType === ua || r.pointerType === da),
        e = (r) => {
          t(r)
            ? (this.touchStartX = r.clientX)
            : this._pointerEvent || (this.touchStartX = r.touches[0].clientX);
        },
        s = (r) => {
          this.touchDeltaX =
            r.touches && r.touches.length > 1
              ? 0
              : r.touches[0].clientX - this.touchStartX;
        },
        n = (r) => {
          t(r) && (this.touchDeltaX = r.clientX - this.touchStartX),
            this._handleSwipe(),
            this._config.pause === "hover" &&
              (this.pause(),
              ...
              (this.touchTimeout = setTimeout(
                ...
                Vo + this._config.interval
              )));
        };
      h.find(oa, this._element).forEach((r) => {
        d.on(r, ta, (o) => o.preventDefault());
      }),
        this._pointerEvent
          ? (d.on(this._element, Zo, (r) => e(r)),
            d.on(this._element, Jo, (r) => n(r)),
            this._element.classList.add(this._classes.pointer),
            this._element.setAttribute(`${na}`, ""))
          : (d.on(this._element, Xo, (r) => e(r)),
            d.on(this._element, Go, (r) => s(r)),
            d.on(this._element, Qo, (r) => n(r)));
    }
    _keydown(t) {
    ...
    _getItemIndex(t) {
      return (
        (this._items = t && t.parentNode ? h.find(fi, t.parentNode) : []),
        this._items.indexOf(t)
      );
    }
    _getItemByOrder(t, e) {
      const s = t === _t;
      return Hi(this._items, e, s, this._config.wrap);
    }
    _triggerSlideEvent(t, e) {
      const s = this._getItemIndex(t),
        n = this._getItemIndex(h.findOne(Mt, this._element));
    ...
    _setActiveIndicatorElement(t) {
      if (this._indicatorsElement) {
        const e = h.findOne(Gs, this._indicatorsElement);
        e.removeAttribute(Xt),
          e.removeAttribute("aria-current"),
          e.classList.remove("!opacity-100");
        const s = h.find(ca, this._indicatorsElement);
        for (let n = 0; n < s.length; n++)
          if (
            Number.parseInt(s[n].getAttribute("data-twe-slide-to"), 10) ===
    ...
    _updateInterval() {
      const t = this._activeElement || h.findOne(Mt, this._element);
      if (!t) return;
    ...
    _slide(t, e) {
      const s = this._directionToOrder(t),
        n = h.findOne(Mt, this._element),
        r = this._getItemIndex(n),
        o = e || this._getItemByOrder(s, n),
        a = this._getItemIndex(o),
        l = !!this._interval,
        u = s === _t,
        c = u ? hi : ea,
        f = u ? ia : sa,
        v = this._orderToDirection(s),
        g = c === hi ? this._classes.slideLeft : this._classes.slideRight,
        O = c !== hi ? this._classes.slideLeft : this._classes.slideRight;
      if (o && o.hasAttribute(Xt)) {
        this._isSliding = !1;
        return;
      }
      if (
        this._isSliding ||
        this._triggerSlideEvent(o, v).defaultPrevented ||
        !n ||
        !o
      )
        return;
      ...
      o.setAttribute(`${f}`, ""),
        o.classList.add(this._classes.block, O),
        Ut(o),
        n.setAttribute(`${c}`, ""),
        n.classList.add(g, ...this._classes.invisible.split(" ")),
        n.classList.remove(...this._classes.visible.split(" ")),
        o.setAttribute(`${c}`, ""),
        o.classList.add(...this._classes.visible.split(" ")),
        o.classList.remove(this._classes.slideRight, this._classes.slideLeft);
      const D = () => {
        o.removeAttribute(c),
          o.removeAttribute(f),
          o.setAttribute(`${Xt}`, ""),
      ...
      this._queueCallback(D, n, !0),
        (l || this._config.ride === !0) && this.cycle();
    }
    _directionToOrder(t) {
      return [qt, mt].includes(t)
        ? W()
          ? t === mt
            ? gt
            : _t
    ...
    static carouselInterface(t, e) {
      const s = q.getOrCreateInstance(t, e);
      let { _config: n } = s;
    ...
    static dataApiClickHandler(t) {
      const e = st(this);
      if (!e) return;
      const s = { ...E.getDataAttributes(e), ...E.getDataAttributes(this) },
        n = this.getAttribute("data-twe-slide-to");
      n && (s.interval = !1),
        q.carouselInterface(e, s),
        n && q.getInstance(e).to(n),
        t.preventDefault();
    }
  }
  const ha = new Set([
    ...
    fa = /^aria-[\w-]*$/i,
    pa = /^data-twe-[\w-]*$/i,
    _a = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
    ga =
    ...
    ma = (i, t) => {
      ...
      if (t.includes(e))
        return ha.has(e)
          ? !!(_a.test(i.nodeValue) || ga.test(i.nodeValue))
          : !0;
  ...
  function Zs(i, t, e) {
    ...
    for (let o = 0, a = r.length; o < a; o++) {
      ...
      const c = [].concat(...l.attributes),
        f = [].concat(t["*"] || [], t[u] || []);
      c.forEach((v) => {
        ma(v, f) || l.removeAttribute(v.nodeName);
      });
    }
  ...
  class Et extends et {
    ...
    toggle(t) {
      if (this._isEnabled)
        if (t) {
          ...
          if (this.getTipElement().classList.contains(pi)) {
    ...
    dispose() {
      clearTimeout(this._timeout),
        d.off(this._element.closest(en), sn, this._hideModalHandler),
    ...
    show() {
      ...
      this.constructor.NAME === "tooltip" &&
        this.tip &&
        this.getTitle() !== this.tip.querySelector(tn).innerHTML &&
        (this._disposePopper(), this.tip.remove(), (this.tip = null));
      const n = this.getTipElement(),
        r = Yn(this.constructor.NAME);
      n.setAttribute("id", r),
      ...
      if (
        (R.setData(n, this.constructor.DATA_KEY, this),
        this._element.ownerDocument.documentElement.contains(this.tip) ||
          (l.append(n),
          d.trigger(this._element, this.constructor.Event.INSERTED)),
        this._popper
          ? this._popper.update()
          : (this._popper = Je(this._element, n, this._getPopperConfig(a))),
      ...
      c && n.classList.add(...c.split(" ")),
        "ontouchstart" in document.documentElement &&
          [].concat(...document.body.children).forEach((g) => {
            d.on(g, "mouseover", se);
          });
      const f = () => {
    ...
    hide() {
      ...
      t.classList.add("opacity-0"),
        ...
        "ontouchstart" in document.documentElement &&
          []
            .concat(...document.body.children)
            .forEach((r) => d.off(r, "mouseover", se)),
    ...
    getTipElement() {
      ...
      return (
        this.setContent(e), e.classList.remove(Ca, pi), (this.tip = e), this.tip
      );
    }
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), tn);
    }
      ...
      if (t !== null) {
        ...
        this._config.html
          ? (this._config.sanitize &&
              (e = Zs(e, this._config.allowList, this._config.sanitizeFn)),
            (t.innerHTML = e))
          : (t.textContent = e);
      }
    }
    ...
    _setListeners() {
      this._config.trigger.split(" ").forEach((e) => {
        if (e === "click")
          ...
          d.on(this._element, s, this._config.selector, (r) => this._enter(r)),
        ...
        d.on(this._element.closest(en), sn, this._hideModalHandler),
        this._config.selector
          ? (this._config = {
              ...this._config,
              trigger: "manual",
    ...
    _fixTitle() {
      const t = this._element.getAttribute("title"),
        e = typeof this._element.getAttribute("data-twe-original-title");
      (t || e !== "string") &&
        (this._element.setAttribute("data-twe-original-title", t || ""),
        t &&
    ...
    _enter(t, e) {
      if (
        ...
        t && (e._activeTrigger[t.type === "focusin" ? gi : Qt] = !0),
        e.getTipElement().classList.contains(pi) || e._hoverState === Gt)
      ) {
        e._hoverState = Gt;
        return;
      }
    ...
    _leave(t, e) {
      if (
        ((e = this._initializeOnDelegatedTarget(t, e)),
        t &&
          (e._activeTrigger[t.type === "focusout" ? gi : Qt] =
    ...
    _getConfig(t) {
      ...
      return (
        ...
        (t.container = t.container === !1 ? document.body : nt(t.container)),
        typeof t.delay == "number" &&
          (t.delay = { show: t.delay, hide: t.delay }),
        typeof t.title == "number" && (t.title = t.title.toString()),
        typeof t.content == "number" && (t.content = t.content.toString()),
        x(Js, t, this.constructor.DefaultType),
        t.sanitize && (t.template = Zs(t.template, t.allowList, t.sanitizeFn)),
        t
      );
    }
    _getDelegateConfig() {
  ...
  const Sa = "popover",
    ...
    Ia = { ...Et.DefaultType, content: "(string|element|function)" },
    Ra = {
      HIDE: `hide${tt}`,
      HIDDEN: `hidden${tt}`,
      SHOW: `show${tt}`,
    ...
    ka = "[data-twe-popover-header-ref]",
    xa = "[data-twe-popover-body-ref]";
  class ge extends Et {
    static get Default() {
      return $a;
    }
    ...
    setContent(t) {
      this._sanitizeAndSetContent(t, this.getTitle(), ka),
        this._sanitizeAndSetContent(t, this._getContent(), xa);
    }
    _getContent() {
  ...
  const mi = "scrollspy",
    ...
    Pa = { offset: "number", method: "string", target: "(string|element)" },
    Ma = {
      active:
    ...
    vi = `activate${Ei}`,
    Va = `scroll${Ei}`,
    Zt = "data-twe-nav-link-active",
    rn = "data-twe-collapsible-scrollspy-ref",
    on = "[data-twe-dropdown-item-ref]",
    Wa = "[data-twe-nav-list-ref]",
    bi = "[data-twe-nav-link-ref]",
    Ba = "[data-twe-nav-item-ref]",
    an = "[data-twe-list-group-item-ref]",
    wi = `${bi}, ${an}, ${on}`,
    ja = "[data-twe-dropdown-ref]",
    Ua = "[data-twe-dropdown-toggle-ref]",
    ln = `[${rn}]`,
    Ya = `[${Zt}]`,
    Ti = "ul",
    Ka = "maxOffset",
  ...
  class me extends et {
    constructor(t, e, s) {
      super(t),
        ...
        d.on(this._scrollElement, Va, () => this._process()),
        this.refresh(),
        this._process(),
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? Ka : cn,
        e = this._config.method === "auto" ? t : this._config.method,
        s = e === cn ? this._getScrollTop() : 0;
      (this._offsets = []),
        (this._targets = []),
        (this._scrollHeight = this._getScrollHeight()),
        h
          .find(wi, this._config.target)
          .map((r) => {
            const o = Re(r),
              a = o ? h.findOne(o) : null;
            if (a) {
              const l = a.getBoundingClientRect();
              if (l.width || l.height) return [E[e](a).top + s, o];
            }
            return null;
          })
          .filter((r) => r)
    ...
    dispose() {
      d.off(this._scrollElement, Ei),
        d.off(this._scrollElement, vi),
        super.dispose();
    }
    _getConfig(t) {
      return (
        ...
        (t.target = nt(t.target) || document.documentElement),
        x(mi, t, Pa),
        t
      );
    }
    ...
    _activate(t) {
      ...
      const e = wi
          .split(",")
          .map((n) => `${n}[data-twe-target="${t}"],${n}[href="${t}"]`),
        s = h.findOne(e.join(","), this._config.target);
      s.classList.add(...this._classes.active.split(" ")),
        s.setAttribute(Zt, ""),
        s.getAttribute(on)
          ? h
              .findOne(Ua, s.closest(ja))
              .classList.add(...this._classes.active.split(" "))
          : h.parents(s, Wa).forEach((n) => {
              h.prev(n, `${bi}, ${an}`).forEach((r) => {
                r.classList.add(...this._classes.active.split(" ")),
                  r.setAttribute(Zt, "");
              }),
                h.prev(n, Ba).forEach((r) => {
                  h.children(r, bi).forEach((o) =>
                    o.classList.add(...this._classes.active.split(" "))
                  );
                });
            }),
        d.trigger(this._scrollElement, vi, { relatedTarget: t });
    }
    _clear() {
      h.find(wi, this._config.target)
    ...
    _hide(t) {
      const e = h.findOne(Ti, t.parentNode);
      ...
      t &&
        t.forEach((e) => {
          const s = e.parentNode,
            n = h.findOne(Ti, s),
            r = n.offsetHeight || n.scrollHeight;
    ...
    _showSubsection() {
      h.find(Ya)
        .filter((s) => s.hasAttribute(rn))
        .forEach((s) => {
          const n = h.findOne(Ti, s.parentNode),
            r = this._collapsibles.find(
              (o) => (o.relatedTarget = s.getAttribute("href"))
            ).height;
          this._show(n, r);
        });
    }
    _hideSubsection() {
      h.find(ln)
        .filter((e) => e.hasAttribute(Zt) === !1)
        .forEach((e) => {
          this._hide(e);
        });
    }
    _bindActivateEvent() {
      d.on(this._element, vi, () => {
        this._showSubsection(), this._hideSubsection();
      });
    }
    static jQueryInterface(t) {
  ...
  const dn = "tab",
    ...
    qa = `show${Ee}`,
    Xa = `shown${Ee}`,
    Ga = "data-twe-dropdown-menu-ref",
    Ht = "data-twe-tab-active",
    ve = "data-twe-nav-active",
    Qa = "[data-twe-dropdown-ref]",
    Za = "[data-twe-nav-ref]",
    un = `[${Ht}]`,
    Ja = `[${ve}]`,
    hn = ":scope > li > .active",
    tl = "[data-twe-dropdown-toggle-ref]",
    el = ":scope > [data-twe-dropdown-menu-ref] [data-twe-dropdown-show]",
    il = { show: "opacity-100", hide: "opacity-0" },
    sl = { show: "string", hide: "string" };
  class be extends et {
    constructor(t, e) {
    ...
    show() {
      if (
        ...
        this._element.getAttribute(ve) === ""
      )
        return;
      let t;
      const e = st(this._element),
        s = this._element.closest(Za),
        n = h.findOne(Ja, s);
      if (s) {
        const l = s.nodeName === "UL" || s.nodeName === "OL" ? hn : un;
        (t = h.find(l, s)), (t = t[t.length - 1]);
      }
      const r = t ? d.trigger(t, Fa, { relatedTarget: this._element }) : null;
      if (
        d.trigger(this._element, qa, { relatedTarget: t }).defaultPrevented ||
        (r !== null && r.defaultPrevented)
      )
        return;
      this._activate(this._element, s, null, n, this._element);
      const a = () => {
        d.trigger(t, za, { relatedTarget: this._element }),
          d.trigger(this._element, Xa, { relatedTarget: t });
      };
      e ? this._activate(e, e.parentNode, a, n, this._element) : a();
    }
    _getClasses(t) {
      const e = E.getDataClassAttributes(this._element);
      return (t = { ...il, ...e, ...t }), x(dn, t, sl), t;
    }
    _activate(t, e, s, n, r) {
      const a = (
        ...
        l = s && a && a.hasAttribute(Ht),
        u = () => this._transitionComplete(t, a, s, n, r);
      a && l
        ? (E.removeClass(a, this._classes.show),
          E.addClass(a, this._classes.hide),
          this._queueCallback(u, t, !0))
        : u();
    }
    _transitionComplete(t, e, s, n, r) {
      if (e && n) {
        e.removeAttribute(Ht), n.removeAttribute(ve);
        const a = h.findOne(el, e.parentNode);
        a && a.removeAttribute(Ht),
      ...
      t.setAttribute(Ht, ""),
        ...
        t.classList.contains(this._classes.hide) &&
          (E.removeClass(t, this._classes.hide),
          E.addClass(t, this._classes.show));
      let o = t.parentNode;
      if (
        (o && o.nodeName === "LI" && (o = o.parentNode),
        o && o.hasAttribute(Ga))
      ) {
        const a = t.closest(Qa);
        a && h.find(tl, a).forEach((l) => l.setAttribute(Ht, "")),
        ...
        379: (s, n, r) => {
          ...
          function c(m, p) {
            for (var _ = {}, b = [], w = 0; w < m.length; w++) {
              var C = m[w],
                A = p.base ? C[0] + p.base : C[0],
                N = _[A] || 0,
                $ = "".concat(A, " ").concat(N);
              _[A] = N + 1;
              var V = u($),
                k = { css: C[1], media: C[2], sourceMap: C[3] };
              V !== -1
                ? (l[V].references++, l[V].updater(k))
                : l.push({ identifier: $, updater: I(k, p), references: 1 }),
                b.push($);
            }
            return b;
          }
...
`)
          ...
          function O(m, p, _, b) {
            var w = _
              ? ""
              : b.media
              ? "@media ".concat(b.media, " {").concat(b.css, "}")
              : b.css;
            if (m.styleSheet) m.styleSheet.cssText = g(p, w);
            else {
              var C = document.createTextNode(w),
                A = m.childNodes;
              A[p] && m.removeChild(A[p]),
                A.length ? m.insertBefore(C, A[p]) : m.appendChild(C);
            }
          }
          function T(m, p, _) {
            var b = _.css,
              ...
              C = _.sourceMap;
            if (
              (w ? m.setAttribute("media", w) : m.removeAttribute("media"),
              C &&
                typeof btoa < "u" &&
                (b += `
/*# sourceMappingURL=data:application/json;base64,`.concat(
          ...
          s.exports = function (m, p) {
            ...
            return function (b) {
              if (
                ...
                for (var A = c(b, p), N = 0; N < _.length; N++) {
                  var $ = u(_[N]);
    ...
    (e.n = (s) => {
      ...
      (e.d = (s, n) => {
        for (var r in n)
          e.o(n, r) &&
            !e.o(s, r) &&
            Object.defineProperty(s, r, { enumerable: !0, get: n[r] });
      }),
  ...
  const Ai = "input",
    we = "twe.input",
    fn = "data-twe-input-wrapper-init",
    pn = "data-twe-input-notch-ref",
    _n = "data-twe-input-notch-leading-ref",
    gn = "data-twe-input-notch-middle-ref",
    nl = "data-twe-input-notch-trailing-ref",
    rl = "data-twe-input-helper-ref",
    ol = "data-twe-input-placeholder-active",
    at = "data-twe-input-state-active",
    mn = "data-twe-input-focused",
    En = "data-twe-input-form-counter",
    Te = `[${fn}] input`,
    Ae = `[${fn}] textarea`,
    Vt = `[${pn}]`,
    vn = `[${_n}]`,
  ...
  class S {
    constructor(t, e, s) {
      (this._config = this._getConfig(e, t)),
        ...
        this._element && (R.setData(t, we, this), this.init());
    }
    static get NAME() {
      return Ai;
    }
    ...
    forceActive() {
      this.input.setAttribute(at, ""),
        h.findOne(Vt, this.input.parentNode).setAttribute(at, "");
    }
    forceInactive() {
      this.input.removeAttribute(at),
        h.findOne(Vt, this.input.parentNode).removeAttribute(at);
    }
    dispose() {
      this._removeBorder(),
        R.removeData(this._element, we),
        (this._element = null);
    }
    _getConfig(t, e) {
      return (
    ...
    _getHelper() {
      this._helper = h.findOne(al, this._element);
    }
    _getCounter() {
      (this._counter = E.getDataAttribute(this.input, "inputShowcounter")),
        this._counter &&
          ((this._maxLength = this.input.maxLength), this._showCounter());
    }
    _getEvents() {
      d.on(this._element, "focus", "input", S.activate(new S())),
        d.on(this._element, "input", "input", S.activate(new S())),
        d.on(this._element, "blur", "input", S.deactivate(new S())),
        d.on(this._element, "focus", "textarea", S.activate(new S())),
        d.on(this._element, "input", "textarea", S.activate(new S())),
        d.on(this._element, "blur", "textarea", S.deactivate(new S())),
        d.on(window, "shown.twe.modal", (t) => {
          h.find(Te, t.target).forEach((e) => {
            const s = S.getInstance(e.parentNode);
            s && s.update();
          }),
        ...
        d.on(window, "shown.twe.dropdown", (t) => {
          ...
          e &&
            (h.find(Te, e).forEach((s) => {
              const n = S.getInstance(s.parentNode);
              n && n.update();
            }),
            h.find(Ae, e).forEach((s) => {
              const n = S.getInstance(s.parentNode);
              n && n.update();
            }));
        }),
        d.on(window, "shown.twe.tab", (t) => {
          ...
          t.target.href
            ...
            : (e = E.getDataAttribute(t.target, "target").split("#")[1]);
          const s = h.findOne(`#${e}`);
          h.find(Te, s).forEach((n) => {
            const r = S.getInstance(n.parentNode);
            r && r.update();
          }),
        ...
        d.on(window, "onautocomplete", (t) => {
          const e = S.getInstance(t.target.parentNode);
          !e || !t.cancelable || e.forceActive();
        });
    }
    _showCounter() {
      if (h.find(`[${En}]`, this._element).length > 0) return;
      (this._counterElement = document.createElement("div")),
        E.addClass(this._counterElement, this._classes.counter),
        this._counterElement.setAttribute(En, "");
    ...
    _showPlaceholder() {
      this.input.setAttribute(ol, "");
    }
    _getNotchData() {
      (this._notchMiddle = h.findOne(bn, this._element)),
        (this._notchLeading = h.findOne(vn, this._element));
    }
    _getLabelWidth() {
    ...
    _getLabelPositionInInputGroup() {
      if (
        ((this._labelMarginLeft = 0),
        !this._element.hasAttribute("data-twe-input-group-ref"))
      )
        return;
      const t = this.input,
        e = h.prev(t, "[data-twe-input-group-text-ref]")[0];
      e === void 0
        ? (this._labelMarginLeft = 0)
    ...
    _applyDivs() {
      const t = this._config.inputFormWhite
        ...
        n = h.find(Vt, this._element),
        r = Yt("div");
      E.addClass(r, this._classes.notch),
        r.setAttribute(pn, ""),
        (this._notchLeading = Yt("div")),
        E.addClass(this._notchLeading, `${this._classes.notchLeading} ${t}`),
        this._notchLeading.setAttribute(_n, ""),
        (this._notchMiddle = Yt("div")),
        E.addClass(this._notchMiddle, `${this._classes.notchMiddle} ${e}`),
        this._notchMiddle.setAttribute(gn, ""),
        (this._notchTrailing = Yt("div")),
        E.addClass(this._notchTrailing, `${this._classes.notchTrailing} ${s}`),
        this._notchTrailing.setAttribute(nl, ""),
        !(n.length >= 1) &&
          (r.append(this._notchLeading),
          r.append(this._notchMiddle),
          r.append(this._notchTrailing),
    ...
    _removeBorder() {
      const t = h.findOne(Vt, this._element);
      t && t.remove();
    }
    _activate(t) {
      Pi(() => {
        ...
        const e = t ? t.target : this.input,
          s = h.findOne(Vt, this._element);
        t && t.type === "focus" && s && s.setAttribute(mn, ""),
          e.value !== "" &&
            (e.setAttribute(at, ""), s && s.setAttribute(at, "")),
    ...
    _getElements(t) {
      if (
        ...
        this._getLabelData(),
          e !== this._labelWidth &&
            ((this._notchMiddle = h.findOne(bn, t.target.parentNode)),
            (this._notchLeading = h.findOne(vn, t.target.parentNode)),
            this._applyNotch());
      }
    }
    _deactivate(t) {
      ...
      const s = h.findOne(Vt, e.parentNode);
      s.removeAttribute(mn),
        e.value === "" && (e.removeAttribute(at), s.removeAttribute(at)),
        this._toggleDefaultDatePlaceholder(e);
    }
    static activate(t) {
      return function (e) {
    ...
    static jQueryInterface(t, e) {
      return this.each(function () {
        let s = R.getData(this, we);
        const n = typeof t == "object" && t;
        if (
          !(!s && /dispose/.test(t)) &&
          (s || (s = new S(this, n)), typeof t == "string")
        ) {
          if (typeof s[t] > "u") throw new TypeError(`No method named "${t}"`);
          s[t](e);
        }
  ...
  const hl = { property: "color", defaultValue: null, inherit: !0 },
    Wt = (i, t) => {
      const { property: e, defaultValue: s, inherit: n } = { ...hl, ...t },
        r = document.createElement("div");
      r.classList.add(i), document.body.appendChild(r);
      const a = window.getComputedStyle(r)[e] || s,
        u = window.getComputedStyle(r.parentElement)[e];
    ...
    pl = ["[data-twe-ripple-init]"],
    Ce = [0, 0, 0],
    _l = [
      {
        name: "primary",
        gradientColor: Wt("text-primary", {
          defaultValue: "#3B71CA",
          inherit: !1,
        }),
      },
      {
        name: "secondary",
        gradientColor: Wt("text-primary-100", {
          defaultValue: "#9FA6B2",
          inherit: !1,
        }),
      },
    ...
    vl = { ripple: "string", rippleWave: "string", unbound: "string" };
  class Oe {
    constructor(t, e, s) {
      (this._element = t),
        ...
        this._element &&
          (R.setData(t, ye, this),
          E.addClass(this._element, this._classes.ripple)),
    ...
    _createRipple(t) {
      ...
      const { layerX: e, layerY: s } = t,
        ...
        c = this._getDiameter(u),
        f = this._options.rippleRadius || c / 2,
        v = { delay: l * wn, duration: l - l * wn },
        g = {
        ...
        O = Yt("div");
      this._createHTMLRipple({ wrapper: this._element, ripple: O, styles: g }),
    ...
    _createHTMLRipple({ wrapper: t, ripple: e, styles: s }) {
      Object.keys(s).forEach((n) => (e.style[n] = s[n])),
        E.addClass(e, this._classes.rippleWave),
        e.setAttribute("data-twe-ripple-ref", ""),
        this._addColor(e, t),
        ...
        (this._rippleTimer = setTimeout(() => {
          if (t && (t.remove(), this._element)) {
            h.find("[data-twe-ripple-ref]", this._element).forEach((n) => {
              ...
              this._isMinWidthSet &&
                (E.style(this._element, { "min-width": "" }),
                (this._isMinWidthSet = !1));
    ...
    _getConfig(t = {}) {
      const e = E.getDataAttributes(this._element);
      return (t = { ...gl, ...e, ...t }), x(yi, t, ml), t;
    }
    _getClasses(t = {}) {
      const e = E.getDataClassAttributes(this._element);
      return (t = { ...El, ...e, ...t }), x(yi, t, vl), t;
    }
    _getDiameter({ offsetX: t, offsetY: e, height: s, width: n }) {
      const r = e <= s / 2,
        o = t <= n / 2,
        a = (v, g) => Math.sqrt(v ** 2 + g ** 2),
        l = e === s / 2 && t === n / 2,
        u = {
          first: r === !0 && o === !1,
          second: r === !0 && o === !0,
    ...
    _toggleUnbound(t) {
      this._options.rippleUnbound === !0
        ? E.addClass(t, this._classes.unbound)
    ...
    _addColor(t) {
      ...
      const s = _l.find((o) => o.name === e.toLowerCase()),
        n = s
          ? this._colorToRGB(s.gradientColor).join(",")
          : this._colorToRGB(e).join(","),
        r = fl.split("{{color}}").join(`${n}`);
    ...
    static jQueryInterface(t) {
      return this.each(function () {
        return R.getData(this, ye) ? null : new Oe(this, t);
      });
    }
    static getInstance(t) {
      return R.getData(t, ye);
    }
    static getOrCreateInstance(t, e = {}) {
      return (
        this.getInstance(t) || new this(t, typeof e == "object" ? e : null)
  ...
  const Ci = "modal",
    ...
    Cn = `resize${X}`,
    On = `click.dismiss${X}`,
    Dn = `keydown.dismiss${X}`,
    Dl = `mouseup.dismiss${X}`,
    Nn = `mousedown.dismiss${X}`,
    Sn = "data-twe-modal-open",
    Ln = "data-twe-open",
    Jt = "[data-twe-modal-dialog-ref]",
    Nl = "[data-twe-modal-body-ref]";
  class te extends et {
    constructor(t, e, s) {
      super(t),
        (this._config = this._getConfig(e)),
        ...
        (this._dialog = h.findOne(Jt, this._element)),
        (this._isShown = !1),
    ...
    show(t) {
      this._isShown ||
        this._isTransitioning ||
        d.trigger(this._element, Cl, { relatedTarget: t }).defaultPrevented ||
        ((this._isShown = !0),
        ...
        d.on(this._dialog, Nn, () => {
          d.one(this._element, Dl, (s) => {
    ...
    hide() {
      if (
        !this._isShown ||
        this._isTransitioning ||
        d.trigger(this._element, Tl).defaultPrevented
      )
        return;
      this._isShown = !1;
      ...
      e && (this._isTransitioning = !0),
        ...
        this._setResizeEvent(),
        this._focustrap.disable(),
        h.findOne(Jt, this._element).classList.remove(this._classes.show),
        d.off(this._element, On),
        d.off(this._dialog, Nn),
        this._queueCallback(() => this._hideModal(), this._element, e),
        this._element.removeAttribute(Ln);
    }
    dispose() {
      [window, document, this._dialog].forEach((t) => d.off(t, X)),
    ...
    _init() {
      this._didInit || (js(te), (this._didInit = !0));
    }
    _initializeBackDrop() {
      return new Vs({
        isVisible: !!this._config.backdrop,
    ...
    _showElement(t) {
      ...
      (!this._element.parentNode ||
        ...
        this._element.setAttribute("aria-modal", !0),
        this._element.setAttribute("role", "dialog"),
        this._element.setAttribute(`${Ln}`, "true"),
        (this._element.scrollTop = 0);
      const n = h.findOne(Jt, this._element);
      ...
      const r = () => {
        this._config.focus && this._focustrap.trap(),
          (this._isTransitioning = !1),
          d.trigger(this._element, Ol, { relatedTarget: t });
      };
    ...
    _setEscapeEvent() {
      this._isShown
        ? d.on(document, Dn, (t) => {
            this._config.keyboard && t.key === Tn
              ? (t.preventDefault(), this.hide())
              : !this._config.keyboard &&
                t.key === Tn &&
                this._triggerBackdropTransition();
          })
        : d.off(this._element, Dn);
    }
    _setResizeEvent() {
      this._isShown
        ? d.on(window, Cn, () => this._adjustDialog())
        : d.off(window, Cn);
    }
    _hideModal() {
      const t = h.findOne(Jt, this._element);
      ...
      setTimeout(() => {
        ...
        (this._isTransitioning = !1),
        this._backdrop.hide(() => {
          document.body.removeAttribute(Sn),
            this._resetAdjustments(),
            this._scrollBar.reset(),
            d.trigger(this._element, yl);
        });
    }
    _showBackdrop(t) {
      d.on(this._element, On, (e) => {
    ...
    _isAnimated() {
      return !!h.findOne(Jt, this._element);
    }
    _triggerBackdropTransition() {
      if (d.trigger(this._element, Al).defaultPrevented) return;
  ...
  const Oi = new $l();
  let Bt;
  const Il = (i) => Bt[i.NAME] || null,
    Rl = (i, t) => {
      if (!i || (!t.allowReinits && Oi.isInited(i.NAME))) return;
      Oi.add(i.NAME);
      const e = Il(i),
        s = (e == null ? void 0 : e.isToggler) || !1;
      if ((Ll(i), e != null && e.advanced)) {
    ...
    kl = { allowReinits: !1, checkOtherImports: !1 };
  class xl {
    constructor(t) {
      $i(this, "init", (t, e) => {
        t.forEach((s) => Rl(s, e));
      ...
      $i(this, "initTWE", (t, e) => {
        const s = { ...kl, ...e },
          n = Object.keys(Bt).map((r) => {
            if (!!document.querySelector(Bt[r].selector)) {
              const a = t[Bt[r].name];
              return (
                !a &&
                  !Oi.isInited(r) &&
                  s.checkOtherImports &&
                  console.warn(
                    `Please import ${Bt[r].name} from "tw-elements" package and add it to a object parameter inside "initTWE" function`
                  ),
                a
              );
            }
